# gsecutil - Google Secret Manager उपकरण
...
🚀 कॉन्फ़िगरेशन फ़ाइल सपोर्ट के साथ Google Secret Manager के लिए सरलीकृत कमांड-लाइन व्रैपर। `gsecutil` आम गुप्त संचालन के लिए सुविधाजनक कमांड प्रदान करता है, जो छोटी टीमों के लिए समर्पित पासवर्ड प्रबंधन उपकरण की आवश्यकता के बिना Google Cloud के Secret Manager का उपयोग करके पासवर्ड और क्रेडेंशियल का प्रबंधन आसान बनाता है।
...
- `-p, --project`: Google Cloud प्रोजेक्ट ID (`GSECUTIL_PROJECT` पर्यावरण चर द्वारा भी सेट किया जा सकता है)
...
- `GSECUTIL_PROJECT`: डिफ़ॉल्ट प्रोजेक्ट ID (`--project` फ़्लैग द्वारा अधिरोहित)

### प्रमाणीकरण

`gsecutil` `gcloud` के समान प्रमाणीकरण का उपयोग करता है। सुनिश्चित करें कि आप प्रमाणित हैं:
...
- **पर्यावरण चर**: दोहराव `--project` फ़्लैग से बचने के लिए `GSECUTIL_PROJECT` सेट करें
