...
> **अनुवाद के बारे में**: यह README फ़ाइल मशीन अनुवादित है। सबसे नवीन और सटीक जानकारी के लिए, कृपया अंग्रेजी संस्करण [README.md](README.md) देखें।

🚀 **v1.0.0** - Google Secret Manager के लिए एक सरलीकृत कमांड-लाइन रैपर। `gsecutil` सामान्य गुप्त ऑपरेशन के लिए सुविधाजनक कमांड प्रदान करता है, जिससे छोटी टीमों को Google Cloud के Secret Manager का उपयोग करके पासवर्ड और प्रमाणपत्र प्रबंधित करने में आसानी होती है, बिना किसी विशेष पासवर्ड प्रबंधन टूल की आवश्यकता के।
...
### 🛡️ **उन्नत पहुंच प्रबंधन** *(v1.0.0 में नया)*
